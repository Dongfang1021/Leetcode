<h2>2134. Minimum Swaps to Group All 1's Together II</h2><h3>Medium</h3><hr><div><p>A <strong>swap</strong> is defined as taking two <strong>distinct</strong> positions in an array and swapping the values in them.</p>
